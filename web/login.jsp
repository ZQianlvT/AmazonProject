...
<div id="register" class="wrap">
	<div class="shadow">
		...
		<div class="box">
			<h1>欢迎回到亚马逊</h1>
			<form id="loginForm" method="post" action="${pageContext.request.contextPath}/UserServlet?method=loginUser" onsubmit="return loginCheck()">
				<table>
					<tr>
					...
					<tr>
						...
						<td><input class="text" type="password" id="passWord" name="pwd" onfocus="FocusItem(this)" onblur="CheckItem(this);" /><a href="retrieve_password.jsp">忘记密码</a></td>
